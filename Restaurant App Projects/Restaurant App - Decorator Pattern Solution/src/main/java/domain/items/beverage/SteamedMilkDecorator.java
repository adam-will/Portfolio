 ...
 * extend the BeverageItem class. Represents an additional ingredient - steamed milk.
 *
 * @author Adam Will
 */
public class SteamedMilkDecorator extends BeverageItemDecorator {

    // constructors
    public SteamedMilkDecorator(BeverageItem beverageComponent) {
        super(new BigDecimal("0.40"), 70, true, false, beverageComponent, "Steamed Milk");
    }
