...
public class RestaurantApp {
     ...
     *                               occupied.
     */
    public static Order openOrder(Table table, WaiterShift waiterShift, int numberOfCovers) {
     ...
     */
    public static OrderItem addItemToOrder(Order order, Item item) {
     ...
     *                                        type food.
     */
    public static void addBeverageExtra(OrderItem orderItem, BeverageExtra beverageExtra) throws OperationNotSupportedException {
        if (orderItem.isConfirmed()) {
            ...
            try {
                orderItem.getItem().addBeverageExtra(beverageExtra);
     ...
     *                                        type beverage.
     */
    public static void addFoodExtra(OrderItem orderItem, FoodExtra foodExtra) throws OperationNotSupportedException {
        if (orderItem.isConfirmed()) {
            throw new OperationNotSupportedException("Cannot add extras to an already confirmed item");
            ...
            try {
                orderItem.getItem().addFoodExtra(foodExtra);
            } catch (OperationNotSupportedException e) {
                System.out.println(e);
            }
        }
